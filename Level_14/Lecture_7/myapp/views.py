...
def show_user_data(request):
    ...
    data2 = User.objects.filter(email='nitish.mahato990@gmail.com')
    data3 = User.objects.filter(mypage__page_cat='Coal')
...
def show_page_data(request):
    ...
    data3 = Page.objects.filter(user__email='nitish.mahato990@gmail.com')
...
def show_post_data(request):
    ...
    data3 = Post.objects.filter(user__username='chinu')
...
def show_song_data(request):
    ...
    data3 = Song.objects.filter(user__username='chinu')
